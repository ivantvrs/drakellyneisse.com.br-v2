...
export default defineConfig(({ mode, isSsrBuild }) => ({
  ...
  plugins: [
    ...
    // DEV-only (apply:"serve"): mapeia as URLs limpas /empresa e /trabalhista -> *.html no dev
    // server, espelhando os rewrites do vercel.json. Não tem efeito no build de produção.
    {
