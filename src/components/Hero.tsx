...
import HeroLightFX from "@/components/HeroLightFX";
...
const Hero = () => {
  ...
  <section id="inicio" className="relative overflow-hidden flex flex-col md:flex-row md:items-center md:min-h-screen" style={{ backgroundColor: '#0F0F0F' }}>
    ...
    <div className="hidden md:block absolute inset-0 z-0">
      {/* Experimento de luz animada (só com ?fx=1|2|3 na URL; sem isso não renderiza) */}
      <HeroLightFX />
      <div
    ...
    <div className="md:hidden relative w-full flex flex-col min-h-[74svh] px-7 pt-20 pb-9 overflow-hidden">
      ...
      {/* label + headline + subheadline + CTA — bloco colado sobre o gradiente escuro */}
      <div className="relative z-10 animate-fade-up">
        {/* label colado ao headline, fora do rosto da Dra. */}
        <p className="font-label text-[11px] tracking-[0.24em] uppercase gold-shine-subtle inline-flex items-center gap-2 mb-4">
          <EmblemIcon />
    ...
    <div className="hidden md:block container mx-auto relative z-10 pt-24 pb-24 md:pt-32">
      <div className="max-w-xl animate-fade-up">
        ...
        {/* Variante desktop da manchete. NÃO é <h1> (o H1 único da página é o do bloco mobile)
            — heading ARIA p/ manter a semântica no viewport ≥768px sem duplicar a tag <h1>. */}
        <p role="heading" aria-level={1} className="font-display text-4xl md:text-5xl lg:text-[3.5rem] font-bold leading-[1.15] mb-6">
          <span style={{ color: '#F5F0E8' }}>Não enfrente a perícia sem </span>
          <span className="gold-shine">um médico do seu lado</span>
          <span style={{ color: '#F5F0E8' }}>.</span>
        </p>
