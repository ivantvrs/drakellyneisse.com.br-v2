...
// Barra fixa (mobile, WhatsApp). Aparece após 3s e some sobre o footer.
// Desktop: o botão flutuante redondo vem do FAB vanilla (public/balanca-fab.js), incluído em at.html.
const AtFloatingCTAs = () => {
  ...
  return (
    <>
      {/* Mobile: barra fixa com WhatsApp */}
      {showBar && (
        <div
